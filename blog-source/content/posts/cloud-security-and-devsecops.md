...
3. **SCA (Software Composition Analysis):** Uygulamanın kullandığı üçüncü parti kütüphanelerin (bağımlılıklerin) zafiyet barındırıp barındırmadığı ve lisans uyumlulukları kontrol edilir. (Örn: Snyk, Dependency-Check).
