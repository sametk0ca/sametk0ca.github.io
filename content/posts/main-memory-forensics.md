...
date: 2026-05-19
description: "How memory forensics uncovers fileless malware and live-session evidence: acquisition, semantic gap and address translation. / Bellek adli bilişiminin dosyasız zararlıları ve canlı oturum kanıtlarını nasıl ortaya çıkardığı: edinim, anlamsal boşluk ve adres çevrimi."
draft: false
tags: ["Forensics", "DFIR", "Malware Analysis", "CyBOK"]
categories: ["Digital Forensics"]
related:
  - "[[concepts/main-memory-forensics|Main Memory Forensics]]"
  - "[[Digital_Forensics|Digital Forensics (Adli Bilişim)]]"
---
...
1. **Bellek Edinimi (Memory Acquisition):** Fiziksel belleğin (RAM) tam bir kopyasının (memory dump) alınması işlemidir. LiME, DumpIt veya WinPmem gibi araçlar kullanılır. "Order of Volatility" (Uçuculuk Sırası) prensibi uyarınca, en uçucu veri önce toplanır; pratikte toplanabilen veriler arasında bellek en öncelikli kaynaktır.
...
1. **Memory Acquisition:** The process of capturing a full copy (memory dump) of the physical RAM. Tools such as LiME, DumpIt, or WinPmem are utilized. According to the "Order of Volatility" principle, the most volatile data is collected first; among the data that can practically be collected, memory is the highest-priority source.
