...
related:
  ...
  - "[[ai-adversarial-techniques|AI Adversarial Techniques (MITRE ATLAS)]]"
  - "[[ebpf-agentic-ai-security|eBPF for Agentic AI Security]]"
  - "[[concepts/prompt-injection|AI Prompt Injection]]"
---

## 🇹🇷 Türkçe (TR)

## Ajan Tabanlı Yapay Zeka Güvenliği: Sohbetten Eyleme Geçen Riskler
...
![Diyagram](/img/mermaid-agentic-ai-security-2026-1-42f1038d.svg)
...
Çalışanların, şirket güvenliğinden onay almadan kendi başlarına devreye aldıkları otonom ajanlar, kurumsal güvenlik çevresinin dışında çalışır ve hassas verilerin kontrolsüzce dışarı sızmasına yol açabilir.

### Savunma Stratejileri

- **İzole Çalıştırma (Sandboxing):** Ajan eylemlerini izole ortamlarda çalıştırın.
- **Döngüde İnsan (Human-in-the-Loop):** Yüksek riskli işlemler için manuel onay isteyin.
- **Ajan Tabanlı SOC:** Diğer ajanların eylemlerini izleyip doğrulayan özel savunma ajanları kullanın.

---

## 🇬🇧 English (EN)

## Agentic AI Security: Risks Beyond the Chatbox
...
![Diagram](/img/mermaid-agentic-ai-security-2026-2-acb01429.svg)
...
Autonomous agents deployed by employees without official security approval can leak sensitive data. These "Shadow Agents" operate outside the corporate security perimeter, creating unmanaged risks.
