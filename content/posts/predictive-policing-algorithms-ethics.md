...
mermaid: false
related:
  - "[[ethics|Ethics in Cyber Security]]"
  - "[[privacy-and-democratic-values|Privacy and Democratic Values]]"
---

## 🇹🇷 Türkçe (TR)

## Geleceğin Suçunu Tahmin Etmek: Predictive Policing ve Algoritmik Önyargı
...
Predictive policing tamamen yasaklanmalı mıdır, yoksa ıslah edilebilir mi? ABD'de Santa Cruz, 2020'de bu teknolojiyi yasaklayan ilk şehir oldu; Los Angeles Polis Departmanı aynı yıl PredPol kullanımını sonlandırdı ve Chicago'nun Stratejik Süje Listesi programı kapatıldı. Sistemlerin devam ettiği bölgelerde ise şu çözümler üzerinde durulmaktadır:
...
## Predicting Future Crimes: Predictive Policing and Algorithmic Bias
...
Should predictive policing be banned entirely, or can it be reformed? In the United States, Santa Cruz became the first city to ban the technology in 2020, the Los Angeles Police Department ended its use of PredPol the same year, and Chicago's Strategic Subject List program was shut down. Where these systems remain active, proposed reforms include:
